...
public class ClientApp {
	...
	public static void main(String[] args) throws Exception {
		...
		// load a CCP
		Path networkConfigPath = Paths.get("/home/connectionProfile", "common-connection.json");
		...
		try (Gateway gateway = builder.connect()) {
			...
			Network network = gateway.getNetwork("ndmcsdmchannel");
			Contract contract = network.getContract(Constants.CONTRACT_NAME);

			byte[] result;

			result = contract.submitTransaction("createBirthCertificate","{\"applicationnumber\":\"0017\",\"registrationnumber\":2,\"divisioncode\":1, \"fathername\" :\"abc\", \"mothername\":\"pqr\",\"permanentaddress\": \"new delhi\", \"fatheroccupation\": 1, \"fatherreligion\":3, \"eventplace\":\"Home\", \"gendercode\" : \"M\", \"idndmcresident\" : \"No\", \"informantaddress\": \"new delhi\", \"informantname\": \"aml\"}");
			System.out.println(new String(result));


			result = contract.evaluateTransaction("queryBirthCertificate","0016");
			System.out.println(new String(result));
//
