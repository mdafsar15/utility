...
public class EnrollAdminGovt {
	...
	public static void main(String[] args) throws Exception {
		...
		//props.put("pemFile", "src/main/java/com/ndmc/ndmc_record/tls-ca-certs/govt/tls-ca-govt-ndmc-com-7054.pem");
		...
		Identity user = Identities.newX509Identity("GOVTMSP", enrollment);
